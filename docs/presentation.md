...
- 37 weather stations x 8 decades = 340+ data chunks
...
| "Southeast 1990s" | Returns globally similar chunks | Metadata filter pre-restricts to Southeast + 1990s |

**Result:** Recall improved from 70% to 90% after adding BM25 + metadata filtering
...
**Impact:** Reduces candidate set from 340 to ~40-80 chunks before search runs
...
**Key optimizations:**
- Trimmed system prompt (80 lines to 15 lines, -600 tokens)
...
3. OpenTelemetry to CloudWatch — Full distributed tracing in production
...
- Performance optimization from 60s to 12s E2E
