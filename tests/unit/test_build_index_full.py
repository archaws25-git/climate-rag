...
class TestSaveAndUpload:
    ...
    def test_saves_index_and_metadata_locally(self, sample_chunks, tmp_path):
    ...
    def test_uploads_to_s3(self, sample_chunks, tmp_path):
    ...
    def test_uploaded_index_is_readable(self, sample_chunks, tmp_path):
...
class TestMain:
    ...
    def test_main_orchestrates_full_pipeline(self, sample_chunks_dir):
